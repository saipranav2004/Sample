...
export const connectPlatform = (input) => demo.connectPlatform(input);
export const disconnectPlatform = (key) => demo.disconnectPlatform(key);
export const fetchPlatformConnection = (key, signal) => demo.fetchPlatformConnection(key, signal);
